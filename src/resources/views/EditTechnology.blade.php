			...
			<div class="kt-portlet__body kt-portlet__body--fit">
				<div class="kt-grid  kt-wizard-v1 kt-wizard-v1--white" id="kt_contacts_add" data-ktwizard-state="step-first">
					<div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
						...
						{!!Form::model($userid, ['route' => ['technology.update', $userid],'enctype'=>'multipart/form-data'])!!}
						@method('PUT')
                    	@csrf
						<form class="kt-form" id="kt_contacts_add_form">
							...
							<div class="kt-wizard-v1__content" data-ktwizard-type="step-content" data-ktwizard-state="current">
								<div class="kt-heading kt-heading--md">Technology:</div>
												...
												<div class="kt-section__body">
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-9">
															...
															{!! Form::text('name', $Technology->technology, ['class' => 'form-control']) !!}
														</div>
													</div>
