												...
												<div class="kt-section__body">
													...
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-9">
															...
															{!! Form::text('Resource_Email', null, ['class' => 'form-control','id' => 'Resource_Email']) !!}
														</div>
													</div>
													...
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-9">
															...
															{!! Form::text('manager_contact', null, ['class' => 'form-control',"id"=>"manager_contact"]) !!}
														</div>
													</div>
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-9">
															...
															{!! Form::text('accountant', null, ['class' => 'form-control','id'=>'accountant']) !!}
													...
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-9">
															...
															{!! Form::text('accountant_email', null, ['class' => 'form-control','id'=>'accountant_email']) !!}
														</div>
													</div>
													...
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-9">
															...
															{!! Form::number('credit_period', null, ['class' => 'form-control','id'=>'credit_period']) !!}
														</div>
													</div>
													...
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-9">
															...
															{!! Form::textarea('address',null,['class'=>'form-control', 'rows' => 4, 'cols' => 40,'id'=>'address']) !!}
														</div>
													</div>
