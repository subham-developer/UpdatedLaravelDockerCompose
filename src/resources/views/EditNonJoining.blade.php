												...
												<div class="kt-section__body">
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-9">
															...
															{{Form::text("",$nonjoiningres[0]->fname.' '.$nonjoiningres[0]->lname,
																[
																"class" => "form-control",
																"id" => "clientname",
																"readonly" => "true"
															...
															{{ Form::hidden("joinid",$nonjoiningres[0]->joining_id, ["id" => "joinigid"]) }}
															{{ Form::hidden("Resources",$nonjoiningres[0]->resource_id, ["id" => "resourceid"]) }}
													...
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-9">
															...
															{{Form::text("clients",$nonjoiningres[0]->client_name,
															             [
															                "class" => "form-control",
															                "id" => "clientname",
																			"readonly" => "true"
															...
															{{ Form::hidden("clientid",$nonjoiningres[0]->clients, ["id" => "clientid"]) }}
														</div>
													</div>
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-9">
															...
															{!! Form::Date('end_date', $nonjoiningres[0]->end_date, ['class' => 'form-control',"id" => "end_date"]) !!}
														</div>
													</div>
								...
								<div class="modal-dialog modal-lg" role="document">
									...
									<div class="modal-content">
										...
										<div class="modal-body">
												...
												<input type="hidden" id="nonjoinid" name="nonjoinid" value="{{ $nonjoiningresid }}">
										</div>
