												...
												<div class="kt-section__body">
													...
													<!-- <div class="form-group row">
														...
														<div class="col-lg-9 col-xl-9">
															...
															{!! Form::Date('date', '', ['class' => 'form-control',"id" =>'datee']) !!}
														</div>
													</div> -->
										<div class="form-group row">
											<label class="col-xl-3 col-lg-3 col-form-label">Date * </label>
											<div class="col-lg-9 col-xl-9">
												<input type="text" class="form-control" id="kt_datetimepicker_1" readonly placeholder="Select date & time" name="date" />
												<!-- <input type="datetime-local" id="datetm" class="form-control" name="date" max="2038-06-14T00:00"> -->
													...
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-9">
															{!! Form::text('point_of_contact', null, ['class' => 'form-control',"id" =>'poc']) !!}
														</div>
													</div>
													...
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-9">
															...
															{!! Form::text('contact_no', null, ['class' => 'form-control',"id" =>'cont']) !!}
														</div>
													</div>
													...
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-9">
															...
															{{Form::select("mode",['Telephonic' => 'Telephonic', 'F2F' => 'F2F'], NUll,
															             [
															                "class" => "form-control",
													...
													<div class="form-group row">
														...
														<div class="kt-radio-inline col-lg-6 col-xl-6">
															<label class="kt-radio">
																<input type="radio" name="Invoice" id="loc1" value="Onsite" class="loc"> Onsite
																<span></span>
															</label>
															<label class="kt-radio">
																<input type="radio" name="Invoice" id="loc2"  value="Office" class="loc"> Office
																<span></span>
															</label>
												...
												<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-9">
															{!! Form::textarea('address',null,['class'=>'form-control', 'rows' => 3, 'cols' => 40,'id' =>'addr']) !!}
														</div>
													</div>
												</div>
											</div>
