    ...
    <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        ...
                        &nbsp;
                        <a href="{{ url('account') }}" class="btn btn-brand btn-elevate btn-icon-sm">
                            <i class="la la-plus"></i> Add Accountant
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="kt-portlet__body kt-portlet__body--fit">
            ...
            <table class="kt-datatable" id="html_table" width="100%">
                ...
                <tbody>
                    @foreach($Accountant as $key => $data)
                        ...
                        <td data-field="Actions" data-autohide-disabled="false" class="kt-datatable__cell">
                            <span style="overflow: visible; position: relative; width: 133px;">		<div class="dropdown">
																...
																<div class="dropdown-menu dropdown-menu-right" style="overflow: visible;">					<ul class="kt-nav">						
																	 ...
																	 <a class="kt-nav__link" href="{{ url('accountantedit/' . $data->id) }}">
																	 	<i class="kt-nav__link-icon flaticon2-contract"></i>
																	 	<span class="kt-nav__link-text">Edit</span>
                            </a>
                            </li>
                            <li class="kt-nav__item">
                                <a class="kt-nav__link" href="#" onclick="deleteAccountant(<?php echo $data->id; ?>)"> <i class="kt-nav__link-icon flaticon2-trash"></i> <span class="kt-nav__link-text">Delete</span> </a>
                            </li>
