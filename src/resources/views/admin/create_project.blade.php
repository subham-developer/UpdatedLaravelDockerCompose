                ...
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="col-md-4">
                                <input type="file" name="feature_image[]" id="input-file-now" class="dropify" data-height="100" required />
                                <br>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="col-md-4">
                                <input type="file" name="cover_image[]" id="input-file-now" class="dropify" data-height="100" required/>
                                <br>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $('#projectForm').submit(function(e){
        ...
        $("#mymce").html(tinymce.get('mymce').getContent());
        ...
        $.ajax({
            ...
            success : function(response){
                ...
                $( "#loader" ).css('visibility', 'hidden');
                $("#errors ul").append("<li>Please Select Featured Image or Cover Image</li>");
                }
