...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
							...
							<div class="kt-portlet kt-portlet--mobile">
									...
									<div class="kt-portlet__head-toolbar">
										<div class="kt-portlet__head-wrapper">
											<div class="kt-portlet__head-actions">
												...
												&nbsp;
												<a href="{{ url('technology') }}" class="btn btn-brand btn-elevate btn-icon-sm">
								...
								<div class="kt-portlet__body kt-portlet__body--fit">
									...
									<!--begin: Datatable -->
									<table class="kt-datatable" id="html_table" width="50%">
										<thead>
											<tr>
												<th title="Field #1">Technology</th>
												...
												<td data-field="Actions" data-autohide-disabled="false" class="kt-datatable__cell">
														<span style="overflow: visible; position: relative; width: 133px;">		<div class="dropdown">
																...
																<div class="dropdown-menu dropdown-menu-right" style="overflow: visible;">					<ul class="kt-nav">						
																	 ...
																	 <a class="kt-nav__link" href="{{ url('technologyedit/' . $data->id) }}">
