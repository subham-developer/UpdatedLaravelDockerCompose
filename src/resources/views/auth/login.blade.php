					...
					<div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
						...
						<div class="wrapper fadeInDown">
							<div id="formContent">
								...
								<!-- Login Form -->
								<form method="post" action="{{ route('normal-login') }}">
									{{ csrf_field() }}
									<input type="email" id="login" class="fadeIn second" name="email" placeholder="email" required="">
									<input type="password" id="password" class="fadeIn third" name="password" placeholder="password" required="">
									<input type="submit" class="fadeIn fourth" value="Log In" style="margin: 0px 0px 20px 0px">
								</form>
								<div class="" style="margin-bottom: 15px"><i>or</i></div>
								<!-- <div class="or-seperator"><i>or</i></div> -->

								<div class="fadeIn first">
									<a href="{{url('login_redirect')}}" class="btn btn-danger btn-block"><i class="la la-google"></i> Sign in with <b>Google</b></a>
								</div>

								<!-- Remind Passowrd -->
								<div id="formFooter">
									<a class="underlineHover" href="javascript:void(0)" onclick="openForgetPassword()">Forgot Password?</a>
								</div>
							...
							<div id="formContent2" style="display: none;">
								...
								<form method="post" action="{{ route('forget-password') }}">
									...
									<input type="submit" class="fadeIn fourth" value="Submit" style="margin: 0px 0px 20px 0px">
								</form>

								<!-- Remind Passowrd -->
								<div id="formFooter">
									<a class="underlineHover" href="javascript:void(0)" onclick="openLogin()">Login</a>
								</div>
